function example_olfati_saber(start_t, dur, att_id, vic_id1, vic_id2, dev_y, sed, dire_csv, posY_csv, dist_csv)
...
for time = p_sim.start_time:p_sim.dt:p_sim.end_time
    ...
    [~, collisions] = swarm.update_command(p_swarm, p_swarm.r_coll, p_sim.dt, time, start_t, dur, att_id, vic_id1, vic_id2, dev_y, dire_csv, posY_csv, dist_csv);
